...
Journal-Modul implementiert und getestet (788 Tests). Nächster Schritt: Backtest auf echter
...
788 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
