...
Journal-Modul implementiert und getestet (573 Tests). Nächster Schritt: Backtest auf echter
...
573 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
