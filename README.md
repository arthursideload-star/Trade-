...
Journal-Modul implementiert und getestet (765 Tests). Nächster Schritt: Backtest auf echter
...
765 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
