...
Journal-Modul implementiert und getestet (578 Tests). Nächster Schritt: Backtest auf echter
...
578 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
