...
Journal-Modul implementiert und getestet (732 Tests). Nächster Schritt: Backtest auf echter
...
732 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
