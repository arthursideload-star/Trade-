...
Journal-Modul implementiert und getestet (698 Tests). Nächster Schritt: Backtest auf echter
...
698 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
