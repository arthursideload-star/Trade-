...
Journal-Modul implementiert und getestet (648 Tests). Nächster Schritt: Backtest auf echter
...
648 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
