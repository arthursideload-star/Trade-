...
Journal-Modul implementiert und getestet (728 Tests). Nächster Schritt: Backtest auf echter
...
728 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
