...
Journal-Modul implementiert und getestet (770 Tests). Nächster Schritt: Backtest auf echter
...
770 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
