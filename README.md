...
Journal-Modul implementiert und getestet (600 Tests). Nächster Schritt: Backtest auf echter
...
600 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
