...
Journal-Modul implementiert und getestet (668 Tests). Nächster Schritt: Backtest auf echter
...
668 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
