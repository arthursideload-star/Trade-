...
Journal-Modul implementiert und getestet (538 Tests). Nächster Schritt: Backtest auf echter
...
538 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
