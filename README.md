...
Journal-Modul implementiert und getestet (543 Tests). Nächster Schritt: Backtest auf echter
...
543 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
