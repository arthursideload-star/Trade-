...
Journal-Modul implementiert und getestet (656 Tests). Nächster Schritt: Backtest auf echter
...
656 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
