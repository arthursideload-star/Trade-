...
Journal-Modul implementiert und getestet (660 Tests). Nächster Schritt: Backtest auf echter
...
660 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
