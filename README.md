...
Journal-Modul implementiert und getestet (706 Tests). Nächster Schritt: Backtest auf echter
...
706 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
