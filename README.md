...
Journal-Modul implementiert und getestet (533 Tests). Nächster Schritt: Backtest auf echter
...
533 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
