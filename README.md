...
Journal-Modul implementiert und getestet (619 Tests). Nächster Schritt: Backtest auf echter
...
619 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
