...
Journal-Modul implementiert und getestet (663 Tests). Nächster Schritt: Backtest auf echter
...
663 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
