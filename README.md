...
Journal-Modul implementiert und getestet (680 Tests). Nächster Schritt: Backtest auf echter
...
680 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
