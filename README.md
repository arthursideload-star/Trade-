...
Journal-Modul implementiert und getestet (693 Tests). Nächster Schritt: Backtest auf echter
...
693 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
