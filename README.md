...
Journal-Modul implementiert und getestet (593 Tests). Nächster Schritt: Backtest auf echter
...
593 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
