...
Journal-Modul implementiert und getestet (574 Tests). Nächster Schritt: Backtest auf echter
...
574 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
