...
Journal-Modul implementiert und getestet (787 Tests). Nächster Schritt: Backtest auf echter
...
787 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
