...
Journal-Modul implementiert und getestet (722 Tests). Nächster Schritt: Backtest auf echter
...
722 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
