...
Journal-Modul implementiert und getestet (564 Tests). Nächster Schritt: Backtest auf echter
...
564 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
