...
Journal-Modul implementiert und getestet (654 Tests). Nächster Schritt: Backtest auf echter
...
654 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
