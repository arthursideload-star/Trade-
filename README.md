...
Journal-Modul implementiert und getestet (643 Tests). Nächster Schritt: Backtest auf echter
...
643 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
