...
Journal-Modul implementiert und getestet (530 Tests). Nächster Schritt: Backtest auf echter
...
530 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
