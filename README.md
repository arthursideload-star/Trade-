...
Journal-Modul implementiert und getestet (794 Tests). Nächster Schritt: Backtest auf echter
...
794 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
