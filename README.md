...
Journal-Modul implementiert und getestet (688 Tests). Nächster Schritt: Backtest auf echter
...
688 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
