...
Journal-Modul implementiert und getestet (522 Tests). Nächster Schritt: Backtest auf echter
...
522 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
