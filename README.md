...
Journal-Modul implementiert und getestet (708 Tests). Nächster Schritt: Backtest auf echter
...
708 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
