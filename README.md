...
Journal-Modul implementiert und getestet (554 Tests). Nächster Schritt: Backtest auf echter
...
554 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
