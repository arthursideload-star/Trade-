...
Journal-Modul implementiert und getestet (707 Tests). Nächster Schritt: Backtest auf echter
...
707 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
