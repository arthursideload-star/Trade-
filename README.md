...
Journal-Modul implementiert und getestet (781 Tests). Nächster Schritt: Backtest auf echter
...
781 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
