...
Journal-Modul implementiert und getestet (774 Tests). Nächster Schritt: Backtest auf echter
...
774 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
