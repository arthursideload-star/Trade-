...
Journal-Modul implementiert und getestet (724 Tests). Nächster Schritt: Backtest auf echter
...
724 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
