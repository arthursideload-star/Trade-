...
Journal-Modul implementiert und getestet (759 Tests). Nächster Schritt: Backtest auf echter
...
759 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
