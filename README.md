...
Journal-Modul implementiert und getestet (549 Tests). Nächster Schritt: Backtest auf echter
...
549 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
