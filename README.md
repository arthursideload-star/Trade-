...
Journal-Modul implementiert und getestet (783 Tests). Nächster Schritt: Backtest auf echter
...
783 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
