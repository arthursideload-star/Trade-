...
Journal-Modul implementiert und getestet (750 Tests). Nächster Schritt: Backtest auf echter
...
750 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
