...
Journal-Modul implementiert und getestet (742 Tests). Nächster Schritt: Backtest auf echter
...
742 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
