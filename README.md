...
Journal-Modul implementiert und getestet (558 Tests). Nächster Schritt: Backtest auf echter
...
558 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
