...
Journal-Modul implementiert und getestet (715 Tests). Nächster Schritt: Backtest auf echter
...
715 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
