...
Journal-Modul implementiert und getestet (682 Tests). Nächster Schritt: Backtest auf echter
...
682 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
