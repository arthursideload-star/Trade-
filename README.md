...
Journal-Modul implementiert und getestet (683 Tests). Nächster Schritt: Backtest auf echter
...
683 Tests, vollständig offline — die HTTP-Schicht ist injizierbar, jede Quelle wird gegen
