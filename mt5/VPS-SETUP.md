...
**Es muss `1819 GoldScalpAssistant.mq5` dastehen.**

- Steht dort `1819` → die Datei ist vollständig angekommen. Weiter bei A5.
...
Es ist **eine einzige Datei**, sonst nichts. 1819 Zeilen.
...
| `wc -l` zeigt nicht 1819 | Datei unvollständig. `rm GoldScalpAssistant.mq5`, dann Schritt 4 wiederholen |
