...
**Es muss `1790 GoldScalpAssistant.mq5` dastehen.**

- Steht dort `1790` → die Datei ist vollständig angekommen. Weiter bei A5.
...
Es ist **eine einzige Datei**, sonst nichts. 1790 Zeilen.
...
| `wc -l` zeigt nicht 1790 | Datei unvollständig. `rm GoldScalpAssistant.mq5`, dann Schritt 4 wiederholen |
