...
**Es muss `1926 GoldScalpAssistant.mq5` dastehen.**

- Steht dort `1926` → die Datei ist vollständig angekommen. Weiter bei A5.
...
Es ist **eine einzige Datei**, sonst nichts. 1926 Zeilen.
...
| `wc -l` zeigt nicht 1926 | Datei unvollständig. `rm GoldScalpAssistant.mq5`, dann Schritt 4 wiederholen |
