...
**Es muss `1895 GoldScalpAssistant.mq5` dastehen.**

- Steht dort `1895` → die Datei ist vollständig angekommen. Weiter bei A5.
...
Es ist **eine einzige Datei**, sonst nichts. 1895 Zeilen.
...
| `wc -l` zeigt nicht 1895 | Datei unvollständig. `rm GoldScalpAssistant.mq5`, dann Schritt 4 wiederholen |
