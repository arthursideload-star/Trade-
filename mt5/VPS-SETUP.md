...
**Es muss `1651 GoldScalpAssistant.mq5` dastehen.**

- Steht dort `1651` → die Datei ist vollständig angekommen. Weiter bei A5.
...
Es ist **eine einzige Datei**, sonst nichts. 1651 Zeilen.
...
| `wc -l` zeigt nicht 1651 | Datei unvollständig. `rm GoldScalpAssistant.mq5`, dann Schritt 4 wiederholen |
